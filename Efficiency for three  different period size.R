...
#Set of shifts  
T=c(2,4,12,15) #First set of shifts
T1=c(8,10,11) # Second and so on . . . .
T2=c(6,25)
T3=c(13,14)
#T4=c(51,53,13,55,56,57,58,59,60,61,62)
#T5=c(30,64,65,67,68,69,70,71)
#T6=c(9,28,37,43,45,54)
#T7=c(13,21)
#T8=c(2,3,13,18)
#T9=c(15,19)
#T10=c(11,11,11)
...
for(i in 1:k1){
  for(j in 1:v){
    ...
    #l12=c(l12,rep((IB12[i]+p[j]+v)%% v))#Increase
  }
}
...
g2= matrix(c(l2),nrow=k3,ncol=v,byrow =  TRUE)
...
print(G2)
G3=cbind(g2,g3)   #Increase as g1, g2, . . . 
print(G3)
...
m=(1/k1*(m1%*%t(m1)))+(1/k2*(m2%*%t(m2))+(1/k3*(m3%*%t(m3))))
